...
// ❌
let str = "123.5";
let num = Number(str); // 123.5
let num2 = parseInt(str); // 123
let num3 = parseFloat(str); //123.5
// ✅
let num = +str; // 123.5
...
/* 8. Use the optional chaining operator (?.) for objects or arrays to avoid “undefined” error */
const response = [
  {
    product: {
...
if (
  ...
  response.length &&
  response[0].product &&
  response[0].product.owner &&
  response[0].product.owner.name
) {
...
/* 9. Get the integer part of a number */
...
/* 11. Removing Falsy Values From Arrays */
...
/* 12. Merge Several Objects Together */
...
/* 15. typeof x === ‘undefined’ && x.length > 0 ? */
//document.all
...
/* 20. Assigning values to multiple variables */
//Longhand ❌
let a, b, c;
a = 5;
b = 8;
...
/* 22. AND(&&) Short circuit evaluation */
//Longhand ❌
if (isLoggedin) {
  goToHomepage();
}
...
/* 25. Deep cloning of multi-level object */
//Longhand ❌
let obj = { x: 20, y: { z: 30 } };
...
/* 28. Return a new mutated clone of the value rather than mutating the value directly and returning it */
// ❌
...
/* 33. Using underscores as a separator for integers */
let number = 1_000_000_000; // one billion

/* 34.  Convert array to an object */
var fruits = ["banana", "apple", "orange"];
var fruitsObj = { ...fruits };
console.log(fruitsObj); // returns {0: “banana”, 1: “apple”, 2: “orange”}

/* 35. Get random value from the array */
var colors = [
  "blue",
  "white",
  "green",
...
/* 37. Sum all the values in the array */
var nums = [1, 5, 2, 6];
var sum = nums.reduce((prev, curr) => prev + curr);
console.log(sum); // returns 14

/* 38. Skip the brackets */
...
/* 40. Get string after last specific character */
"filename.pdf".split(".").pop(); //pdf

/* 41. Get CSS Variable in JS */
